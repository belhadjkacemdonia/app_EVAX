...
class pass_vacc extends StatefulWidget{
  const pass_vacc({super.key});

  @override
  pass_vaccState createState() => pass_vaccState();
}
class pass_vaccState extends State<pass_vacc>{
                      ...
                      child: Card(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            ListTile(
                              title: Text('VACCINE PASSPORT COVID-19',
